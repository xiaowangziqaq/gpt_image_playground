...
export default function SearchBar() {
  ...
  return (
    <div data-no-drag-select className="mt-6 mb-4 flex flex-col sm:flex-row gap-3">
      <div className="flex gap-2 flex-shrink-0 z-20">
        ...
        <div className="relative flex-1 sm:flex-initial sm:w-28">
          <Select
            ...
            className="w-full px-3 py-2.5 rounded-xl border border-gray-200 dark:border-white/[0.08] bg-white dark:bg-gray-900 hover:bg-gray-50 dark:hover:bg-white/[0.06] text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/30 focus:border-blue-400 transition"
          />
        </div>
      </div>
